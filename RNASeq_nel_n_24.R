...
write.csv(meanFDR, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanFDR_nel_n_24.csv")
write.csv(meanPower, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanPower_nel_n_24.csv")
write.csv(meantotreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meantotreject_nel_n_24.csv")
write.csv(stdreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/stdreject_nel_n_24.csv")
