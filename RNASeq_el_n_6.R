...
if(equal){
	...
	expected.lib.size <- 20e6 * c(rep(1, 0.5), samplesize/2)
}
...
write.csv(meanFDR, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanFDR_el_n_6.csv")
write.csv(meanPower, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanPower_el_n_6.csv")
write.csv(meantotreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meantotreject_el_n_6.csv")
write.csv(stdreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/stdreject_el_n_6.csv")


meanFDR <- read.csv("D:/Dongmei/Research/NGS/RNASeq_simulation/meanFDR_el_n_6.csv", header = TRUE)
meanPower <- read.csv("D:/Dongmei/Research/NGS/RNASeq_simulation/meanPower_el_n_6.csv", header = TRUE)
meantotreject <- read.csv("D:/Dongmei/Research/NGS/RNASeq_simulation/meantotreject_el_n_6.csv", header = TRUE)
stdreject <- read.csv("D:/Dongmei/Research/NGS/RNASeq_simulation/stdreject_el_n_6.csv", header = TRUE)

meanFDR <- meanFDR[, -1] 
meanPower <- meanPower[, -1]
meantotreject <- meantotreject[, -1]
stdreject <- stdreject[, -1]
...
postscript(file="RNA_Seq_comparison_nel_n_24.eps", width=4, height=4)
...
plot(diffpro, meanFDR$edgeR_exact, type="l", lty=1, lwd=2, col="blue", ylim=g_range, ann=FALSE)
box()
lines(diffpro, meanFDR$edgeR_glm, type="l", lty=2, lwd=2, col="red")
lines(diffpro, meanFDR$DESeq, type="l", lty=3, lwd=2, col="darkgreen")
lines(diffpro, meanFDR$DESeq2, type="l", lty=4, lwd=2, col="black")
lines(diffpro, meanFDR$baySeq, type="l", lty=5, lwd=2, col="grey")
lines(diffpro, meanFDR$EBSeq, type="l", lty=6, lwd=2, col="orange")
lines(diffpro, meanFDR$SAMSeq, type="l", lty=1, lwd=2, col="yellowgreen")
lines(diffpro, meanFDR$NOISeq, type="l", lty=2, lwd=2, col="purple")
lines(diffpro, meanFDR$Voom, type="l", lty=3, lwd=2, col="brown4")
...
plot(diffpro, meanPower$meanPower_edgeR_exact, type="l", lty=1, lwd=2, col="blue", ylim=g_range, ann=FALSE)
box()
lines(diffpro, meanPower$meanPower_edgeR_glm, type="l", lty=2, lwd=2, col="red")
lines(diffpro, meanPower$meanPower_DESeq, type="l", lty=3, lwd=2, col="darkgreen")
lines(diffpro, meanPower$meanPower_DESeq2, type="l", lty=4, lwd=2, col="black")
lines(diffpro, meanPower$meanPower_baySeq, type="l", lty=5, lwd=2, col="grey")
lines(diffpro, meanPower$meanPower_EBSeq, type="l", lty=6, lwd=2, col="orange")
lines(diffpro, meanPower$meanPower_SAMSeq, type="l", lty=1, lwd=2, col="yellowgreen")
lines(diffpro, meanPower$meanPower_NOISeq, type="l", lty=2, lwd=2, col="purple")
lines(diffpro, meanPower$meanPower_Voom, type="l", lty=3, lwd=2, col="brown4")
...
plot(diffpro, meantotreject$meantotRejection_edgeR_exact, type="l", lty=1, lwd=2, col="blue", ylim=g_range, ann=FALSE)
box()
lines(diffpro, meantotreject$meantotRejection_edgeR_glm, type="l", lty=2, lwd=2, col="red")
lines(diffpro, meantotreject$meantotRejection_DESeq, type="l", lty=3, lwd=2, col="darkgreen")
lines(diffpro, meantotreject$meantotRejection_DESeq2, type="l", lty=4, lwd=2, col="black")
lines(diffpro, meantotreject$meantotRejection_baySeq, type="l", lty=5, lwd=2, col="grey")
lines(diffpro, meantotreject$meantotRejection_EBSeq, type="l", lty=6, lwd=2, col="orange")
lines(diffpro, meantotreject$meantotRejection_SAMSeq, type="l", lty=1, lwd=2, col="yellowgreen")
lines(diffpro, meantotreject$meantotRejection_NOISeq, type="l", lty=2, lwd=2, col="purple")
lines(diffpro, meantotreject$meantotRejection_Voom, type="l", lty=3, lwd=2, col="brown4")
title(xlab=expression(pi[1]))
...
plot(diffpro, stdreject$vartotRejection_edgeR_exact, type="l", lty=1, lwd=2, col="blue", ylim=g_range, ann=FALSE)
box()
lines(diffpro, stdreject$vartotRejection_edgeR_glm, type="l", lty=2, lwd=2, col="red")
lines(diffpro, stdreject$vartotRejection_DESeq, type="l", lty=3, lwd=2, col="dark green")
lines(diffpro, stdreject$vartotRejection_DESeq2, type="l", lty=4, lwd=2, col="black")
lines(diffpro, stdreject$vartotRejection_baySeq, type="l", lty=5, lwd=2, col="grey")
lines(diffpro, stdreject$vartotRejection_EBSeq, type="l", lty=6, lwd=2, col="orange")
lines(diffpro, stdreject$vartotRejection_SAMSeq, type="l", lty=1, lwd=2, col="yellowgreen")
lines(diffpro, stdreject$vartotRejection_NOISeq, type="l", lty=2, lwd=2, col="purple")
lines(diffpro, stdreject$vartotRejection_Voom, type="l", lty=3, lwd=2, col="brown4")
title(xlab=expression(pi[1]))
