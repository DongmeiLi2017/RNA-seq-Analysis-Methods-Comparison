  ...
  while (num<=total)
{
  ...
  group2.norm <- round(edgeR.dgelist$counts, 0)
...
write.csv(meanFDR, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanFDR_nel_n_48.csv")
write.csv(meanPower, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanPower_nel_n_48.csv")
write.csv(meantotreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meantotreject_nel_n_48.csv")
write.csv(stdreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/stdreject_nel_n_48.csv")
...
pdf(file="RNA_Seq_comparison_nel_n_48.pdf", width=4, height=4)
...
postscript(file="RNA_Seq_comparison_nel_n_48.eps", width=4, height=4)
...
pdf(file="RNA_Seq_comparison_nel_n_48_lineplot.pdf", width=4, height=4)
