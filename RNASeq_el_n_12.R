...
write.csv(meanFDR, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanFDR_el_n_12.csv")
write.csv(meanPower, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meanPower_el_n_12.csv")
write.csv(meantotreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/meantotreject_el_n_12.csv")
write.csv(stdreject, file="D:/Dongmei/Research/NGS/RNASeq_simulation/stdreject_el_n_12.csv")
...
pdf(file="RNA_Seq_comparison_el_n_12.pdf", width=4, height=4)
...
postscript(file="RNA_Seq_comparison_el_n_12.eps", width=4, height=4)
...
pdf(file="RNA_Seq_comparison_el_n_12_lineplot.pdf", width=4, height=4)
